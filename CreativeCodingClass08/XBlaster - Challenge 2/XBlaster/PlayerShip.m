...
- (instancetype)initWithPosition:(CGPoint)position
{
  if (self = [super initWithPosition:position]) {
    ...
    ventingPlasma =
      [NSKeyedUnarchiver unarchiveObjectWithFile:
       [[NSBundle mainBundle] pathForResource:@"plasma"
                                       ofType:@"sks"]];
      ventingPlasma.position = CGPointMake(1, -4);
      ventingPlasma.name = @"ventingPlasma";
      ventingPlasma.hidden = YES;
